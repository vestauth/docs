      ...
      <div className="not-prose mt-4 grid grid-cols-1 gap-x-6 gap-y-10 border-t border-zinc-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:max-w-none xl:grid-cols-3">
        <div key="nodejs" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Node.js</p>
        ...
        <div key="python" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Python</p>
        ...
        <div key="ruby" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Ruby</p>
        ...
        <div key="go" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Go</p>
        ...
        <div key="php" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with PHP</p>
        ...
        <div key="rust" className="flex flex-row-reverse gap-6">
          <div className="flex-auto">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Rust</p>
