    ...
    <>
      <div key="astro" className="flex flex-row-reverse gap-6">
        <div className="flex-auto">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Astro</p>
      ...
      <div key="express" className="flex flex-row-reverse gap-6">
        <div className="flex-auto">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Express</p>
      ...
      <div key="next" className="flex flex-row-reverse gap-6">
        <div className="flex-auto">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Next.js</p>
      ...
      <div key="remix" className="flex flex-row-reverse gap-6">
        <div className="flex-auto">
          ...
          <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Use vestauth with Remix</p>
