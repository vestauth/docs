...
const FeedbackThanks = forwardRef(function FeedbackThanks(_props, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-vest-50/50 py-1 pl-1.5 pr-3 text-sm text-vest-900 ring-1 ring-inset ring-vest-500/20 dark:bg-vest-500/5 dark:text-vest-200 dark:ring-vest-500/30">
        <CheckIcon className="h-5 w-5 flex-none fill-vest-500 stroke-white dark:fill-vest-200/20 dark:stroke-vest-200" />
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://x.com/vestauth" icon={XIcon}>
          Follow us on X
        </SocialLink>
        <SocialLink href="https://github.com/vestauth/vestauth" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
      </div>
    </div>
