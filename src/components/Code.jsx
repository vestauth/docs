  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-vest-400/10 ring-1 ring-inset ring-vest-400/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-vest-400 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0'
        )}
      >
        Copied!
